...
//       expect(jest.spyOn(rateLimitService, 'store')).not.toHaveBeenCalled();
//     });
...
//     it('tx method is eth_sendRawTransaction and successful and rateLimitPlugin is set', async () => {
//       const allowedMethods: RegExp[] = [/^.*$/];
//       const rateLimitPlugin = 'redis';
//       const method = 'eth_sendRawTransaction';
//       const headers = { host: 'localhost' };
...
//       const result = await proxyService.requestVerse(headers, body);
//       expect(jest.spyOn(rateLimitService, 'store')).toHaveBeenCalled();
//       expect(result).toEqual(postResponse);
//     });

//     it('tx method is eth_sendRawTransaction and successful and rateLimitPlugin is empty', async () => {
//       const allowedMethods: RegExp[] = [/^.*$/];
//       const method = 'eth_sendRawTransaction';
//       const headers = { host: 'localhost' };
//       const body = {
